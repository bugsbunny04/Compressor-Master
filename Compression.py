...
class Compressor:
    ...
    def get_sorted_tuple(self):
        ...
        #print("sadasdsadsadasdadasdsadasdasdasdsadasdasdasdasd")
        #print(self.sorted_counted_of_words)
    ...
    def make_hash(self):
        k = 0
        j = 0
        #print(self.sorted_counted_of_words[k][0])
        #print(self.sorted_counted_of_words[k][1])
        #print(self.sorted_counte d_of_words[0])
